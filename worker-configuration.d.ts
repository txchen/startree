/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=local` (hash: 2c2129528aa100ded8baecf3db7e7072)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_VERSION">> {}
}
